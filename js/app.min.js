...
let top2 = document.documentElement.scrollTop.toFixed(); document.onscroll = () => {
...
let preloader = document.querySelector('.preloader'); let body = document.querySelector('body'); window.onload = () => { setTimeout(() => { !preloader.classList.contains('done') && preloader.classList.add('done') }, 1500), setTimeout(() => { preloader.classList.contains('done') && preloader.classList.add('done2'), body.classList.add('plus_overflow') }, 3500) }
